...
//   useEffect(() => {
//     // Find the matching service by its unique ID
//     const foundService = SERVICES.find((item) => item.__id === service);
//     if (foundService) {
...
//         <div className="border rounded-lg shadow-md p-4">
//           <div
//             className="p-3 text-sm font-medium text-gray-500 text-justify"
